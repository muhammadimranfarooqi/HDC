...
/**
 * Servlet implementation class PrintBloodCollectionServlet
 */
@WebServlet("/PrintBloodCollectionServlet")
public class PrintBloodCollectionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintBloodCollectionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			String filepath = session.getServletContext().getRealPath("/WEB-INF/reports/bloodcollection_print.jasper");
