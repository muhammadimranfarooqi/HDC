...
/**
 * Servlet implementation class PrintXrayServlet
 */
@WebServlet("/PrintXrayServlet")
public class PrintXrayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public PrintXrayServlet() {
        super();
...
String dirpath = session.getServletContext().getRealPath("/WEB-INF/reports/");
			...
			String filepath = session.getServletContext().getRealPath("/WEB-INF/reports/xray_print.jasper");
